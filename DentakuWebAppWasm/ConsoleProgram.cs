...
internal static partial class ConsoleProgram
{
    private static readonly CultureInfo Culture = CultureInfo.InvariantCulture;

#if !WASM
    public static async Task Main() => await RunAsync();
#endif

    public static async Task RunAsync()  // ← Blazorから呼び出すメソッド
    {
#if !WASM
...
internal static class Calculator
{
    ...
    public static double Divide(double left, double right) => right != 0 ? left / right : throw new DivideByZeroException("Division by zero is not allowed.");
}
